...
def detect_people(L,frame, net, ln, personIdx=0):
...
def detector(input,L):
	...
	# Path and naming of output file

    output = str(datetime.datetime.now()) + ".avi"
    ...
    while True:
        ...
        results = detect_people(L,frame, net, ln,personIdx=LABELS.index("person"))
